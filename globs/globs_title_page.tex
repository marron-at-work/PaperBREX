...
\author{Phyllis Lim \and Connor Adkins \and Mark Marron\footnote{Corresponding Author: Mark Marron, mark.marron@uky.edu}}
\date{}
...
from build scripts and configuration files to web servers. However, this widespread use rests on a fragile foundation. Despite their ubiquity across tools 
...
\subsection*{Keywords}
Globs, Pattern Matching, Domain Specific Language, Software Engineering
