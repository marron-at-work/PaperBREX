...
\item \textbf{Build Systems}: Tools like Make employ globs for file specification
\item \textbf{Resource Identification}: Patterns appear in URLs and URIs for hierarchical matching
\item \textbf{Web Development}: Frameworks like Express.js use glob-like syntax for route definitions
\end{itemize}
