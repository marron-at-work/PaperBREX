...
The analysis of developer discussions ($2,094$ in total) reveals how glob implementation inconsistencies translate into 
...
\begin{figure}[ht]
    ...
    \caption{Distribution of $2,094$ glob-related issues, derived from developer discussions, across six primary categories -- security, features, reliability, usability, 
    compatibility, performance, and other. \todo{Should sort this from highest to lowest and other as bottom category (maybe in shaded grey) dont color security -- also make sure label does not cover the bars.}}
...
\begin{figure}[ht]
    ...
    denial-of-service attacks, which represent a emerging threat vector globs are increasingly used in validation checks for URI resource access and API path routing. \todo{Review legend size to make sure fonts are legible.}}
