...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{reliability_usability.pdf}
    \caption{Breakdown of $491$ reliability and usability issues from developer discussions.}
    \label{fig:reliability_usability}
\end{figure}

\Cref{fig:reliability_usability} shows that runtime errors dominate reliability issues ($190$ posts, $48.5\%$). The high proportion of runtime errors suggests that glob implementations often encounter conditions 
...
Documentation gaps represent a significant usability barrier, comprising $64$ posts ($26.1\%$ of usability issues). Developers consistently report insufficient documentation 
