...
\begin{figure}[htbp]
    ...
    \caption{Distribution of glob pattern occurrence across programming languages. Fig. (a) shows the percentage of repositories containing at least on glob pattern. Fig. (b) 
...
style tasks that are seen with regular expressions (the most common structured text processing DSL).
...
Out qualitative data study utilizes 2,094 developer discussions from three complementary sources ranging from 2018-2024 to capture a broad spectrum of glob-related issues 
...
We performed API scraping with keyword-based filtering \texttt{(core: "glob", "wildcard"; feature-specific: "recursive glob", "brace expansion"; problem-specific: "glob error", "security")}~\cite{labelprediction}
